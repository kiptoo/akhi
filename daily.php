  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1Past Weather Patterns>
        Daily Observations
        <small>Select a farm and select the date to view the daily observation.</small>
      </h1>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Daily weather observation</h4>
      </div>
      <div class="modal-body">
        <p>Select a past date</p>
        <form method="GET" action="daily2.php">
