...
if($forecastStatusCode==200){  	// Code 200 means the request was successful
    ...
    echo "<h3> Select a farm to view the agronomic values </h3>";
  ...
  ?>
  <a href="#" data-toggle="modal" data-target="#<?php echo "$farms3[fieldid]";?>">View agronomics</a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">View Agronomics</h4>
      </div>
      <div class="modal-body">
        <p>Enter the start and end date</p>
        <form method="GET" action="agronomics.php">
