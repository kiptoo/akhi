 ...
 $.ajax({
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Platings
        <small>Select a field to view plantings or add a new planting</small>
      </h1>
    ...
    <div class="box box-solid bg-white-gradient">
            ...
            <div class="box-body">
              ...
              while ($plantings3=mysql_fetch_array($plantings2))
              //A link to view the plantings
              {
                  ?><a href="viewplantings.php? farmid=<?php echo $plantings3['fieldid'];?>"><?php echo $plantings3['name'];?></a><br/><?php
              }
