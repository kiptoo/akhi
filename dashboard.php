  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Fields</span></a></li>
        <li><a href="#"><i class="fa fa-link"></i> <span>Plantings</span></a></li>
        <li class="header">WEATHER</li>
          <li><a href="#"><i class="fa fa-link"></i> <span>Current Conditions</span></a></li>
           <li><a href="#"><i class="fa fa-link"></i> <span>Forecasts</span></a></li>
            <li><a href="#"><i class="fa fa-link"></i> <span>Daily Observations</span></a></li>
             <li><a href="#"><i class="fa fa-link"></i> <span>Weather Maps</span></a></li>
