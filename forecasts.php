  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Select a farm and select the dates to view future weather forecasts.</small>
      </h1>
    ...
    <div class="box box-solid bg-white-gradient">
            ...
            <div class="box-body">
              ...
              {
                  ?> <a href="#" data-toggle="modal" data-target="#<?php echo "$farms3[fieldid]";?>"><?php echo "$farms3[name]";?></a><br/>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">View future weather forecasts</h4>
      </div>
      <div class="modal-body">
        <p>Enter the start and end date (At most a week from today)</p>
        <form method="GET" action="forecast2.php">
